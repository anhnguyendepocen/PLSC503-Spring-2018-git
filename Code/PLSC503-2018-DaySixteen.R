####################################################
# PLSC 503 -- Spring 2018: Code for Day Sixteen
####################################################
...
mu<-c(0,0,0) # <== X, Z, U
Sigma<-matrix(c(1,0.8,0.4,0.8,1,0,0.4,0,1),nrow=3,byrow=TRUE) # Cor(X,Y)=0.8, etc.
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-Spring-2018-git/master/Data/IRData.csv")
